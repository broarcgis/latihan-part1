...
public class LocationResourceIntTest {
    ...
    private static final String DEFAULT_CONTENT_LOCATION = "AAAAAAAAAA";
    private static final String UPDATED_CONTENT_LOCATION = "BBBBBBBBBB";
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location()
            .content_location(DEFAULT_CONTENT_LOCATION);
        return location;
    }
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getContent_location()).isEqualTo(DEFAULT_CONTENT_LOCATION);
    }
    ...
    @Test
    @Transactional
    public void checkContent_locationIsRequired() throws Exception {
        int databaseSizeBeforeTest = locationRepository.findAll().size();
        // set the field null
        location.setContent_location(null);
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].content_location").value(hasItem(DEFAULT_CONTENT_LOCATION.toString())));
    }
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.content_location").value(DEFAULT_CONTENT_LOCATION.toString()));
    }
    ...
    public void updateLocation() throws Exception {
        ...
        updatedLocation
            .content_location(UPDATED_CONTENT_LOCATION);
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getContent_location()).isEqualTo(UPDATED_CONTENT_LOCATION);
    }
